...
const router = Router();
import { getSingleThought, getThoughts, createThought, updateSingleThought, deleteSingleThought, addReaction, removeReaction, } from '../../controllers/thoughtController.js';
