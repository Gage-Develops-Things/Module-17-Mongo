...
export const updateSingleThought = async (req, res) => {
    try {
...
export const deleteSingleThought = async (req, res) => {
    try {
        ...
        const oneLessThought = await User.findOneAndUpdate({ friends: req.params.thoughtId }, { $pull: { friends: req.params.thoughtId } }, { new: true });
        if (!oneLessThought) {
